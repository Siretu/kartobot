...
unsigned long uxTaskGetRunTimeCounter( xTaskHandle const pxTask ) PRIVILEGED_FUNCTION;
xTaskHandle * const pxTaskGetByID( unsigned portBASE_TYPE uxID ) PRIVILEGED_FUNCTION;
