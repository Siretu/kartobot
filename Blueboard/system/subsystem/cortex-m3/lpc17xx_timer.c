...
void TIM_Init(LPC_TIM_TypeDef *TIMx, TIM_MODE_OPT TimerCounterMode, void *TIM_ConfigStruct)
{
	...
	if (TIMx== LPC_TIM0)
	{
		...
		//PCLK_Timer0 = CCLK/4
//		CLKPWR_SetPCLKDiv (CLKPWR_PCLKSEL_TIMER0, CLKPWR_PCLKSEL_CCLK_DIV_4);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
	}
	else if (TIMx== LPC_TIM1)
	{
		CLKPWR_ConfigPPWR (CLKPWR_PCONP_PCTIM1, ENABLE);
		//PCLK_Timer1 = CCLK/4
//		CLKPWR_SetPCLKDiv (CLKPWR_PCLKSEL_TIMER1, CLKPWR_PCLKSEL_CCLK_DIV_4);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
	...
	else if (TIMx== LPC_TIM2)
	{
		...
		//PCLK_Timer2= CCLK/4
//		CLKPWR_SetPCLKDiv (CLKPWR_PCLKSEL_TIMER2, CLKPWR_PCLKSEL_CCLK_DIV_4);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
	}
	else if (TIMx== LPC_TIM3)
	{
		CLKPWR_ConfigPPWR (CLKPWR_PCONP_PCTIM3, ENABLE);
		//PCLK_Timer3= CCLK/4
//		CLKPWR_SetPCLKDiv (CLKPWR_PCLKSEL_TIMER3, CLKPWR_PCLKSEL_CCLK_DIV_4);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
