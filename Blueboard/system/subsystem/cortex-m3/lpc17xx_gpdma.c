 ...
 *********************************************************************/
Status GPDMA_Setup(GPDMA_Channel_CFG_Type *GPDMAChannelConfig, GPDMA_Increment_Type increment)
{
	...
	case GPDMA_TRANSFERTYPE_M2P:
		...
		pDMAch->DMACCControl
				= GPDMA_DMACCxControl_TransferSize((uint32_t)GPDMAChannelConfig->TransferSize) \
						...
						| ((increment == GPDMA_DO_INCREMENT) ? GPDMA_DMACCxControl_SI : 0UL) \
						| GPDMA_DMACCxControl_I;
		break;
	...
	case GPDMA_TRANSFERTYPE_P2M:
		...
		pDMAch->DMACCControl
				= GPDMA_DMACCxControl_TransferSize((uint32_t)GPDMAChannelConfig->TransferSize) \
						...
						| ((increment == GPDMA_DO_INCREMENT) ? GPDMA_DMACCxControl_DI : 0UL) \
						| GPDMA_DMACCxControl_I;
		break;
