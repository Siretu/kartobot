...
void DAC_Init(LPC_DAC_TypeDef *DACx)
{
	...
	// CLKPWR_SetPCLKDiv (CLKPWR_PCLKSEL_DAC, CLKPWR_PCLKSEL_CCLK_DIV_4);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
