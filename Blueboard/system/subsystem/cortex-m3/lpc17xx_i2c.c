...
void I2C_Init(LPC_I2C_TypeDef *I2Cx, uint32_t clockrate)
{
	...
	if (I2Cx==LPC_I2C0)
	{
		 ...
		 * is set to FCCLK / 2 */
//		CLKPWR_SetPCLKDiv(CLKPWR_PCLKSEL_I2C0, CLKPWR_PCLKSEL_CCLK_DIV_2);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
	}
	else if (I2Cx==LPC_I2C1)
	{
		 ...
		 * is set to FCCLK / 2 */
//		CLKPWR_SetPCLKDiv(CLKPWR_PCLKSEL_I2C1, CLKPWR_PCLKSEL_CCLK_DIV_2);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
	}
	else if (I2Cx==LPC_I2C2)
	{
		 ...
		 * is set to FCCLK / 2 */
//		CLKPWR_SetPCLKDiv(CLKPWR_PCLKSEL_I2C2, CLKPWR_PCLKSEL_CCLK_DIV_2);//Errata: Peripheral Clock Selection Registers must be set before enabling and connecting PLL0
	}
	else {
...
{
	return I2C_MasterComplete[I2C_getNum(I2Cx)];
}
...
{
	return I2C_SlaveComplete[I2C_getNum(I2Cx)];
}
