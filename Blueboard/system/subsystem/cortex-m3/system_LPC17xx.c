...
#define PCLKSEL0_Val          0x00009000
#define PCLKSEL1_Val          0x00200880
...
//  SCB->VTOR  = 0x00000000 & 0x3FFFFF80; //ROM
//  SCB->VTOR  = 0x10000000 & 0x3FFFFF80; //RAM
  extern unsigned long __cs3_interrupt_vector;
  SCB->VTOR  = (unsigned long)&__cs3_interrupt_vector & 0x3FFFFF80; //ldscript placement
}
