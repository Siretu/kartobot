 ...
 *---------------------------------------------------------------------------*/
#ifndef __USBDESC_CDC_H__
#define __USBDESC_CDC_H__
...
const uint8_t USB_CDC_DeviceDescriptor[] = {
...
const uint8_t USB_CDC_ConfigDescriptor[] = {
/* Configuration 1 */
...
const uint8_t USB_CDC_StringDescriptor[] = {
