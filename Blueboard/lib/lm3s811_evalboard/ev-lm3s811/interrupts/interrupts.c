...
#ifdef __GNUC__
void IntGPIOa(void) __attribute__((__interrupt__)); 
#endif
void
IntGPIOa(void)
{
...
// mthomas: attribute for stack-aligment (see README_mthomas.txt)
#ifdef __GNUC__
void IntGPIOb(void) __attribute__((__interrupt__)); 
#endif
void
IntGPIOb(void)
{
...
// mthomas: attribute for stack-aligment (see README_mthomas.txt)
#ifdef __GNUC__
void IntGPIOc(void) __attribute__((__interrupt__)); 
#endif
void
IntGPIOc(void)
{
