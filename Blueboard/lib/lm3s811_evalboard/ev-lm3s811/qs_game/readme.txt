EV-LM3S811 Quickstart Application
...
button being pressed while waiting to start the game (i.e. it will never come
on during game play).  An implementation of the Game of Life is run with a
