...
{ 
  #ifdef LCD_TYPE
  {
    ...
    {
	  scu_pinmux(4, 7, MD_PUP, FUNC0);		/* LCD_DCLK @ P4.7 */	
	  scu_pinmux(7, 0, MD_PUP, FUNC3);		/* LCD_LE @ P7.0 */
	  scu_pinmux(4, 5, MD_PUP, FUNC2);		/* LCD_FP @ P4.5 */
	  scu_pinmux(7, 6, MD_PUP, FUNC3);		/* LCD_LP @ P7.6 */
	  scu_pinmux(7, 7, MD_PUP, FUNC3); 		/* LCD_PWR @ P7.7 */  	  	
  	  scu_pinmux(4, 6, MD_PUP, FUNC2); 		/* LCD_ENAB_M @ P4.6 */
	  scu_pinmux(4, 1, MD_PUP, FUNC2);		/* LCD_VD_0 @ P4.1 */
	  scu_pinmux(4, 4, MD_PUP, FUNC2);		/* LCD_VD_1 @ P4.4 */
	  scu_pinmux(4, 3, MD_PUP, FUNC2);		/* LCD_VD_2 @ P4.3 */
	  scu_pinmux(4, 2, MD_PUP, FUNC2);		/* LCD_VD_3 @ P4.2 */
	  scu_pinmux(8, 7, MD_PUP, FUNC3);		/* LCD_VD_4 @ P8.7 */
	  scu_pinmux(8, 6, MD_PUP, FUNC3);		/* LCD_VD_5 @ P8.6 */
	  scu_pinmux(8, 5, MD_PUP, FUNC3);		/* LCD_VD_6 @ P8.5 */
	  scu_pinmux(8, 4, MD_PUP, FUNC3);		/* LCD_VD_7 @ P8.4 */
    }
    ...
    #else
    {
  	  #error "Unkown LCD Type - check lcd_type.h"	
    }
    #endif
  }
  #else
  {
    #error "LCD Type Not Defined - check lcd_type.h"	
  }
  #endif
}
