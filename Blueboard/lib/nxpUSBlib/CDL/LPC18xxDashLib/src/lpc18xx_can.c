...
//	if(IFsel == IF1){
//		return (LPC_C_CAN->IF1_reg);
//	}else{
//		return (LPC_C_CAN->IF2_reg);
//	}
//}
//void CAN_IF_Write(uint32_t reg, uint32_t IFsel,uint32_t val){
//	if(IFsel == IF1){
//	(LPC_C_CAN->IF1_reg=val);
//	}else{
//		(LPC_C_CAN->IF2_reg=val);
//	}
//}
//
///* Macro for writing IF to specific RAM message object */
...
//	if(IFsel == IF1){
//	LPC_C_CAN->IF1_CMDMSK_W=RD|MASK|ARB|CTRL|CLRINTPND|DATAA|DATAB;
//	LPC_C_CAN->IF1_CMDREQ=msg;
//	while (LPC_C_CAN->IF1_CMDREQ & IFCREQ_BUSY );
//	}else{
//	  LPC_C_CAN->IF2_CMDMSK_W=RD|MASK|ARB|CTRL|CLRINTPND|DATAA|DATAB;
//	  LPC_C_CAN->IF2_CMDREQ=msg;
//	  while (LPC_C_CAN->IF2_CMDREQ & IFCREQ_BUSY );
//  }
//
//}
//
...
//	if(IFsel == IF1){
//  LPC_C_CAN->IF1_CMDMSK_W=WR|MASK|ARB|CTRL|CLRINTPND|DATAA|DATAB;
//  LPC_C_CAN->IF1_CMDREQ=msg;
//  while (LPC_C_CAN->IF1_CMDREQ & IFCREQ_BUSY );
//	}else{
//		  LPC_C_CAN->IF2_CMDMSK_W=WR|MASK|ARB|CTRL|CLRINTPND|DATAA|DATAB;
//		  LPC_C_CAN->IF2_CMDREQ=msg;
//		  while (LPC_C_CAN->IF2_CMDREQ & IFCREQ_BUSY );
//	}
//}
